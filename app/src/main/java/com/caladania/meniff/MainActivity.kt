...
import com.caladania.meniff.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    object Global_ma {
        ...
        //очки игроков
        var pointsPlayerOne = 10
        var pointsPlayerTwo = 10
        //ставки игроков
        var flagBetPlayer = true
        var betPlayerOne = 1
        var betPlayerTwo = 1
        var questNumPlayerOne = 1
        var questNumPlayerTwo = 1
    ...
    private fun loadMainFragment() {
        supportFragmentManager.beginTransaction().run {
            add(R.id.containerFragments, mainFragment)
            this.commit()
        }
    }
...
//                flagStartPrxy = true
//                StartAP_ma()
//                StartNW_ma(instance_anotherchange.freq_prefer_tochange)
//            }
